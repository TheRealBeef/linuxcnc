...
int draw_primitives::get_shapetype(Handle(AIS_Shape) aShape){

    TopoDS_Edge anEdge = TopoDS::Edge(aShape->Shape());
...
void draw_primitives::get_closest_point_to_line( gp_Pnt Point, gp_Pnt LineStart, gp_Pnt LineEnd, gp_Pnt &Intersection )
{
    double U;
    double LineMag = LineEnd.Distance(LineStart);
    ...
    Intersection.SetZ( LineStart.Z() + U * ( LineEnd.Z() - LineStart.Z() ) );
}
