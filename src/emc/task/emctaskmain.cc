...
static EMC_JOINT_SET_MAX_JERK *set_joint_max_jerk_msg;
static EMC_AXIS_SET_MAX_JERK *set_axis_max_jerk_msg;
...
static int emcTaskPlan(void)
{
    ...
    case EMC_TASK_STATE::ESTOP_RESET:
        ...
        case EMC_TASK_MODE::MDI:
            ...
            case EMC_AXIS_SET_MAX_JERK_TYPE:
...
static int emcTaskIssueCommand(NMLmsg * cmd)
{
    ...
    case EMC_JOINT_SET_MAX_JERK_TYPE:
        set_joint_max_jerk_msg = (EMC_JOINT_SET_MAX_JERK *) cmd;
        retval =
                emcJointSetMaxJerk(set_joint_max_jerk_msg->joint,
                                   set_joint_max_jerk_msg->max_jerk);
        break;
